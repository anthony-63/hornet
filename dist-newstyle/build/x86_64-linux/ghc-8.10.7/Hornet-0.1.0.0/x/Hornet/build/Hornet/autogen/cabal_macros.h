...
/* package Hornet-0.1.0.0 */
#ifndef VERSION_Hornet
#define VERSION_Hornet "0.1.0.0"
#endif /* VERSION_Hornet */
#ifndef MIN_VERSION_Hornet
#define MIN_VERSION_Hornet(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Hornet */
...
#define CURRENT_COMPONENT_ID "Hornet-0.1.0.0-inplace-Hornet"
